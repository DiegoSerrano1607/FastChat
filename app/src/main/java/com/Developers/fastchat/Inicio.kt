...
class Inicio : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        auth = FirebaseAuth.getInstance() /*Se debe de llamar antes la autenticación para que funcione el log de Google*/
    ...
    private fun EmpezarinicioSesionGoogle() {
        ...
        Toast.makeText(this, "Lanzando Google Sign-In", Toast.LENGTH_SHORT).show()
        Log.d("DEBUG", "Lanzando Google Sign-In")
    ...
    private fun ComprobarSesion(){
        ...
        if(firebaseUser!=null){
            ...
            Toast.makeText(applicationContext, "La sesión se encuentra activa", Toast.LENGTH_SHORT).show()
            startActivity(intent)
            finish()
        }
    }
